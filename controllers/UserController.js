...
const update = async (req, res) => {
    try {
        ...
        // update user
        const user = await User.findByIdAndUpdate(req.params.id, fields, { new: true }); // params ini untuk mengambil id dari url, kalau untuk fullname, email, role kita simpen di body karena kita melewatkannya melalui form
